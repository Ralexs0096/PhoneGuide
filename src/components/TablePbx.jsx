...
const TablaPbx = () => {
  const [dataPbx, setDataPbx] = useState(data)

  const extensionesElements = dataPbx.map(
    ({ ext, user, dept, country, state }) => (
      <tr key={ext}>
        ...
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
          <p className="text-gray-900 whitespace-no-wrap">{country}</p>
        </td>
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
